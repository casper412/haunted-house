  ...
  setup: (ctx) => {
    ...
    return {
      ...
      questions: [
        ...
        { question_text: 'Which shows good "netiquette" online?', 
          possible_answers: [
            'Downloading a game without telling parents', 
            'Watching movies you are not supposed to',
            'Asking before doing something that you are unsure about',
            'Saying mean things to your friends online'], 
          correct_answer: 2 },
        { question_text: 'What is the safe thing to do?', 
          possible_answers: [
            'Not ask if the pan is hot, and touch it', 
            'Try and jump over an iron',
            'Leave the stove on after you are done',
            'Unplug the saw when you are done'], 
          correct_answer: 3 },
        { question_text: 'Which answers are using good sportsmanship?', 
          possible_answers: [
            'Screaming and yelling because you lost', 
            'Winning without bragging or being mean',
            'Hit your opponents when they score on you',
            'Making fun of the people that lost'], 
          correct_answer: 1 },
        { question_text: 'What words are in the Scout Law?', 
          possible_answers: [
            'Clean', 
            'Kind',
            'Brave',
            'All of the Above'], 
          correct_answer: 3 },
        { question_text: 'What does it mean to be clean in your outdoor manners?', 
          possible_answers: [
            'Wash your hands outside', 
            'Don\'t wear dirty clothes outside',
